...
class IndicatorElement extends 	statesMixin(HTMLElement, ['counter']){
    ...
    constructor(){
        super();
        this.innerHTML = '<h1> we got : ' + this.counter.toString() + ' </h1> by the way if click here I set it to 7';
    ...
    on_update_counter(val){
        ...
        this.innerHTML = '<h1> we got : ' + val.toString() + ' </h1> by the way if click here I set it to 7'; 
    }
